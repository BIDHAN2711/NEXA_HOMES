...
<div id="fullscreenContainer" onclick="closeFullscreen()">
            ...
            <span class="navbar-toggler-icon"></span>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="LoanHome_Carloan.php#contact">Contact</a></li>
                </ul>
    ...
    <div class="container">
        <div class="hero-section row align-items-center">
            <div class="col-md-6">
                <h1 class="display-5 fw-bold">Drive Your Dream Car with Ease – New & Used Car Loans Made Simple</h1>
                <p class="lead">Looking to buy a brand-new car or a certified used vehicle? Our comprehensive car loan solutions are designed to make vehicle ownership easy, affordable, and stress-free. We provide new car loans and used car loans with flexible repayment options, low interest rates, and quick disbursal—so you can focus on the joy of driving, not the burden of financing.

                    Whether you're a first-time buyer or upgrading to a better model, our car financing options offer up to 100% funding of the on-road price, zero hidden charges, and minimal documentation. With attractive EMI plans, doorstep assistance, and a seamless online application process, you can get approved within hours and drive away with confidence.</p>
            </div>

            <div class="col-md-6 text-center">
                <img src="LoanHome_carloanwebpic.jpg" alt="NexaHomes Business Loan" class="hero-img">
            </div>
            <!-- Apply Now Button -->
            <div class="mt-4">
        ...
        <div class="content-section">
            ...
            <p>Applying for a car loan is a great way to own a car and repay by manageable EMIs. Follow the documents list below to qualify and speed up the loan process.</p>

            <h4>Car Loan Documents - Salaried Individuals</h4>
            <ul>
                <li>Identity Proof: Aadhaar card, PAN card, Driving Licence, Passport, Voter ID</li>
                <li>Address Proof: Aadhaar card, Passport, Driving Licence, Utility bill</li>
                <li>Age Proof: Birth certificate, Aadhaar card, 10th mark sheet</li>
                <li>Proof Of Income: Salary slips (last 3 months), Form 16, IT return</li>
                <li>Bank Statement: 3-6 months</li>
                <li>Vehicle Loan Agreement: Dealer quote reflecting car price</li>
            </ul>

            <h4>Car Loan Documents – Self-Employed Professionals</h4>
            <ul>
                <li>Identity & Address Proof: Aadhaar, PAN, Passport, Driving Licence, Utility bill</li>
                <li>Age Proof: Birth certificate, Aadhaar card, School transfer certificate</li>
                <li>Bank Statement: Last 3–6 months</li>
                <li>Business Ownership Proof: Business registration, Utility bill, Office address</li>
                <li>Proof Of Income: ITR (2 years), Audited balance sheet, Profit & loss statement</li>
                <li>Vehicle Loan Agreement: Reflecting selected car's price</li>
            </ul>

            <h4>Car Loan Documents - Self-Employed Non-Professionals</h4>
            <ul>
                <li>Age Criteria: 21–65 years; Business age: at least 3 years</li>
                <li>Income Criteria: Business stability of 2–3 years</li>
                <li>Other Documents: Business registration & address proof</li>
            </ul>

            <h2 class="mt-5">Get an Instant Car Loan at the NexaHomes</h2>
            <p>NexaHomes offers up to 90% (100% for select models) financing on car value with low interest rates and flexible repayment up to 84 months. Benefits include:</p>
            <ul>
                <li>Minimal processing and foreclosure charges</li>
                <li>Quick loan approvals and low down payments</li>
                <li>Easy online EMI calculator</li>
            </ul>
            <p>Apply online or visit the nearest NexaHomes branch to get started.</p>
        </div>
