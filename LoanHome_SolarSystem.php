...
<head>
    ...
    <meta name="description" content="Get easy and affordable solar system loans with low EMIs, fast approvals, and government subsidies. Apply now for solar panel loans for homes and businesses.">
    <meta name="keywords" content="solar system loan, solar panel loan, rooftop solar loan, PM Surya Ghar Yojana, solar energy financing, clean energy loan">
            ...
            <span class="navbar-toggler-icon"></span>
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="LoanHome_SolarSystem.php#contact">Contact</a></li>
                </ul>
...
<div class="container">
    ...
    <div class="hero-section row align-items-center">
        <div class="col-md-6">
            <h1 class="display-5 fw-bold">Power Your Home with Clean Energy – Easy Solar System Loans with Low EMIs</h1>
            <p class="lead">Switching to solar energy is a smart investment—for both your wallet and the planet. With our specially designed solar system loans, you can install a complete solar panel setup at your home or business without the burden of heavy upfront costs. We offer flexible financing options, low interest rates, and customized EMI plans to make solar energy affordable for everyone.</p>
            <p>Whether you're looking to reduce electricity bills or move toward sustainable living, our solar panel loans help you take the next step with ease.</p>
            <div class="mt-4">
        ...
        <div class="col-md-6 text-center">
            <img src="LoanHome_solarwebpic.png" alt="NexaHomes Solar Loan" class="hero-img">
        </div>
    </div>

    <!-- Solar Loan Details Section -->
    <div class="hero-section">
        <h2 class="fw-bold mb-3">Flexible Financing for Solar Energy Systems – Quick Approvals & Maximum Savings</h2>
        <p>Our solar loans are ideal for homeowners, small businesses, and institutions looking to adopt renewable energy solutions. We provide financing for both on-grid and off-grid solar systems, covering equipment, installation, and maintenance. Enjoy benefits like minimal documentation, fast approvals, and loan tenures of up to 7 years.</p>
        <p>Join the clean energy revolution with a loan that’s built to support your green goals.</p>
        <table class="table table-bordered">
            <thead>
                <tr>
                    <th>S.N.</th>
                    <th>Parameter</th>
                    <th>Eligibility Conditions (Up-to ₹2 Lac)</th>
                    <th>Eligibility Conditions (>₹2 Lacs and up to ₹6 Lacs)</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td>1</td>
                    <td>Purpose</td>
                    <td>Installation of Solar Roof Top for Loan amounts up to ₹2 lacs</td>
                    <td>Installation of Solar Roof Top for Loan amount above ₹2 lacs & up to ₹6 lac</td>
                </tr>
                <tr>
                    <td>2</td>
                    <td>Loan Amount</td>
                    <td>Maximum ₹2 lacs</td>
                    <td>Maximum ₹6 lacs</td>
                </tr>
                <tr>
                    <td>3</td>
                    <td>Age & Other Eligibility Conditions</td>
                    <td colspan="2">• Age up to 65 years (loan must be closed before borrower reaches 70)<br>• Up to 75 years with co-borrower<br>• CIBIL score: No minimum for ₹2 lacs, 650+ for > ₹2 lacs<br>• Roof rights, sufficient area, electricity bill, savings account</td>
                </tr>
                <tr>
                    <td>4</td>
                    <td>PAN</td>
                ...
                <tr>
                    <td>5</td>
                    <td>Margin</td>
                    <td colspan="2">Minimum 10% of Project Cost</td>
                </tr>
                <tr>
                    <td>6</td>
                    <td>Interest Rate</td>
                    <td>EBLR - 2.15% (Effective: 6.75%)</td>
                    <td>EBLR + 0% (Effective: 8.90%)</td>
                </tr>
                <tr>
                    <td>7</td>
                    <td>Tenor</td>
                    <td colspan="2">Up to 120 months (no pre-payment penalty)</td>
                </tr>
                <tr>
                    <td>8</td>
                    <td>Security</td>
                    <td colspan="2">Hypothecation of Assets</td>
                </tr>
                <tr>
                    <td>9</td>
                ...
                <tr>
                    <td>10</td>
                    <td>Subsidy</td>
                    <td>1KW – ₹30,000<br>2KW – ₹60,000<br>3KW – ₹78,000<br>Claim via suryaghar.gov.in</td>
                    <td>₹78,000<br>Claim via suryaghar.gov.in</td>
                </tr>
                <tr>
                    <td>11</td>
                    <td>Net Annual Income</td>
                    <td>Not Required</td>
                    <td>Minimum ₹3 lacs</td>
                </tr>
                <tr>
                    <td>12</td>
                    <td>Documents Required</td>
                    <td>KYC, Electricity Bill</td>
                    <td>KYC, ITR/Form-16 (2 yrs), Salary Slip (6 months), Electricity Bill</td>
                </tr>
                <tr>
                    <td>13</td>
                    <td>Moratorium</td>
                    <td colspan="2">6 Months from Disbursement Date</td>
                </tr>
                <tr>
                    <td>14</td>
                    <td>Disbursement</td>
                    <td colspan="2">Direct to Vendor/EPC Contractor after MNRE-required reports</td>
                </tr>
                <tr>
                    <td>15</td>
                    <td>Other Covenants</td>
                    <td colspan="2">Register at pmsuryaghar.gov.in, apply via jansamarth.in, asset insurance required for >3KW systems</td>
                </tr>
            </tbody>
        </table>
    </div>
